defmodule Dnsimple.ServicesTest do
  ...
  describe ".list_services" do
    ...
    test "returns the services in a Dnsimple.Response", %{
      fixture: fixture,
      method: method,
      url: url
    } do
  ...
  describe ".applied_services" do
    ...
    test "returns applied services in a Dnsimple.Response", %{
      fixture: fixture,
      method: method,
      url: url
    } do
    ...
    test "correctly parses the applied service's Settings", %{
      fixture: fixture,
      method: method,
      url: url
    } do
