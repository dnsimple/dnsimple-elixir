defmodule Dnsimple.Webhooks do
  ...
  """
  @spec get_webhook(Client.t(), String.t() | integer, String.t() | integer, Keyword.t()) ::
          {:ok | :error, Response.t()}
  ...
  """
  @spec create_webhook(Client.t(), String.t() | integer, map, Keyword.t()) ::
          {:ok | :error, Response.t()}
  ...
  **Warning**: this is a destructive operation.
  ...
  """
  @spec delete_webhook(Client.t(), String.t() | integer, String.t() | integer, Keyword.t()) ::
          {:ok | :error, Response.t()}
