defmodule Dnsimple.Certificates do
  ...
  """
  @spec list_certificates(Client.t(), String.t() | integer, String.t() | integer, Keyword.t()) ::
          {:ok | :error, Response.t()}
  ...
  def download_certificate(client, account_id, domain_id, certificate_id, options \\ []) do
    url =
      Client.versioned(
        "/#{account_id}/domains/#{domain_id}/certificates/#{certificate_id}/download"
      )
  ...
  """
  @spec get_certificate_private_key(
          Client.t(),
          String.t() | integer,
          String.t() | integer,
          integer,
  ...
  def get_certificate_private_key(client, account_id, domain_id, certificate_id, options \\ []) do
    url =
      Client.versioned(
        "/#{account_id}/domains/#{domain_id}/certificates/#{certificate_id}/private_key"
      )
  ...
  ## Examples
      ...
      client = %Dnsimple.Client{access_token: "a1b2c3d4"}
      {:ok, response} = Dnsimple.Certificates.issue_letsencrypt_certificate(client, account_id = "1010", domain_id = "example.com", certificate_id = 100)

  """
  @spec issue_letsencrypt_certificate(
          Client.t(),
          String.t() | integer,
          String.t() | integer,
          integer,
  ...
  def issue_letsencrypt_certificate(client, account_id, domain_id, certificate_id, options \\ []) do
    url =
      Client.versioned(
        "/#{account_id}/domains/#{domain_id}/certificates/letsencrypt/#{certificate_id}/issue"
      )
  ...
  def purchase_letsencrypt_certificate_renewal(
    ...
    url =
      Client.versioned(
        "/#{account_id}/domains/#{domain_id}/certificates/letsencrypt/#{certificate_id}/renewals"
      )
  ...
  """
  @spec issue_letsencrypt_certificate_renewal(
          Client.t(),
          String.t() | integer,
          String.t() | integer,
          integer,
  ...
  def issue_letsencrypt_certificate_renewal(
    ...
    url =
      Client.versioned(
        "/#{account_id}/domains/#{domain_id}/certificates/letsencrypt/#{certificate_id}/renewals/#{certificate_renewal_id}/issue"
      )
